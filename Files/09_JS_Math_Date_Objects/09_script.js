...
// }
// console.log(triangleOne(theStr));
// <!-- write a function for another triangle two -->
// function triangleTwo(str){
//     var tempStr='';
//
//     for(var i=0;i<str.length;i++){
//
//      tempStr+= addSpace(i)+str.substr(i,str.length)+'\n';
//
//     }
//     return tempStr;
// }
...
// }
//
// console.log(triangleTwo('sanjeev'));
// function triangleThree(str){
//
// }
// function butterflyStr(str){
...
//     for(var i=0;i<str.length;i++)
//     {
//         tempStr+=str.substr(0,i+1)+addSpace(2*str.length-2*(i+1))+ str.substr(str.length-(i+1))+'\n';
//     }
//      for(var i=str.length-1;i>=0;i--){
//         tempStr+=str.substr(0,i)+addSpace(2*str.length-(i+1))+ str.substr(str.length-(i))+'\n';
//      }
//
//
//     return tempStr;
// }
// console.log(butterflyStr('sanjeev'))